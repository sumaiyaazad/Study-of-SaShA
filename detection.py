...
from detections.RDMA_Detector import RDMADetector
...
rdma_predictor = RDMADetector(data, -1)
print("------------------RDMA Top Fake Profiles--------------------------------------------")
fake_profile_list = rdma_predictor.predict_fake_profiles(fake_profile_file+"_rdma.txt")
print(fake_profile_list)
